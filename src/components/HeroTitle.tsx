...
export default function HeroTitle({
  ...
  brushstrokeAlt = "",
  subtitleStyles = "mb-8 text-[10px] font-sans font-bold uppercase tracking-[0.3em] text-white/70 text-left",
  mainTitleStyles = "font-serif font-black italic leading-[0.75] tracking-[-0.05em] text-white text-[5rem] sm:text-[6.5rem] md:text-[8rem] lg:text-[10rem]",
  prefixStyles = "text-white relative z-30 mr-4 sm:mr-6 select-none shrink-0 font-serif font-black italic",
  deathRowStyles = "relative z-20 text-black font-serif font-black italic uppercase leading-none tracking-[-0.04em] whitespace-nowrap px-2 py-1",
