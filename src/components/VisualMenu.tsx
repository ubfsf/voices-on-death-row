...
export default function VisualMenu({ sections }: VisualMenuProps) {
  ...
  const MENU_ITEMS = [
    ...
    { 
      title: "", 
      slug: "about", 
      img: "/images/about.jpg", // Make sure you have this image
      chapter: "Chapter V",
      ref: "F-505",
      desc: "The story behind Voices on Death Row.",
      align: "left"
    },
  ];
  ...
  return (
    <div className="bg-black min-h-screen text-white font-serif overflow-x-hidden selection:bg-white selection:text-black">
      ...
      <section className="py-40 md:py-80 flex flex-col items-center justify-center text-center px-6 bg-[#030303]">
        ...
        <h3 className="text-2xl sm:text-4xl md:text-6xl font-light italic text-stone-400 max-w-4xl leading-tight tracking-tight px-4">
