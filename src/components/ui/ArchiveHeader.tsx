...
export default function ArchiveHeader({ label, word }: ArchiveHeaderProps) {
  return (
    <div className="border-b border-black pb-12">
      <p className="text-black font-sans text-[10px] uppercase tracking-[1em] mb-4">{label}</p>
      <h1 className="text-6xl md:text-[8vw] font-black italic uppercase tracking-tighter leading-none text-black">
