  ...
  return (
    <main className="page-paper pt-12 pb-40 px-6 md:px-16">
      ...
      <div className="relative z-10 max-w-7xl mx-auto pt-32 px-6 md:px-16">
        <ArchiveHeader label="Connection // Vol. 04" word="Contact" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-16 py-20 grid grid-cols-1 lg:grid-cols-12 gap-20">
        ...
        <div className="lg:col-span-5 space-y-16">
          <motion.article 
            ...
            className="space-y-8"
          >
            <p className="text-xl md:text-2xl leading-relaxed text-stone-600 font-light italic">
              {t('form_description')}
            </p>
            
            <div className="pt-12 space-y-4 border-t border-stone-200">
              <p className="text-2xl text-black font-black uppercase tracking-tight italic">
                {t('founder_name')}
              </p>
              <div className="flex flex-col gap-2">
                <span className="text-stone-400 font-mono text-[10px] uppercase tracking-widest font-bold">
                  Direct Correspondence
                </span>
                <a 
                  href={`mailto:${t('founder_email')}`}
                  className="text-stone-500 hover:text-black transition-colors text-lg border-b border-stone-300 hover:border-stone-500 w-fit pb-1"
                >
                  {t('founder_email')}
                </a>
              </div>
          ...
          <motion.div 
            ...
            className="bg-white backdrop-blur-md p-10 border border-stone-200 shadow-2xl relative overflow-hidden group"
          >
            {/* Archival Stamp Effect */}
            <div className="absolute top-4 right-4 w-12 h-12 border border-stone-300 rounded-full flex items-center justify-center text-stone-400 font-mono text-[8px] rotate-12 group-hover:border-stone-500 group-hover:text-stone-500 transition-colors">
              USA
            </div>

            <h3 className="text-stone-400 font-mono text-[10px] uppercase tracking-[0.4em] font-bold mb-8">
      ...
      <div className="relative z-10 py-40 flex flex-col items-center justify-center text-center">
        <div className="w-px h-24 bg-gradient-to-b from-stone-300 to-transparent mb-8" />
        <p className="text-stone-400 font-mono text-[9px] uppercase tracking-[1.5em]">
          End of Dossier
        </p>
      </div>
    </main>
